...
void _3309(input_stream<channel_i32_30>* _3309_5021, output_stream<channel_i32_30>* _3309_5022) {
	...
	//i32 p_cont_5029;
	{
		cont_5029 = readincr_v<4>(_3309_5021);
		//cont_5029 = readincr(_3309_5021);
		p_cont_5029 = cont_5029;
		goto cont_5027;
	}
cont_5027: {
		   cont_5029 = p_cont_5029;
		   writeincr(_3309_5022, cont_5029);
		   goto _3309_5043;
	   }
_3309_5043: {
		    return;
...
//		cgra_graph() {
//			// Nodes
//			//_5040 = adf::input_plio::create(adf::plio_32_bits, FILE_ADDR);
//			_5040 = adf::input_plio::create(adf::plio_32_bits);
//			k_3309 = adf::kernel::create(_3309);
//			//_5041 = adf::output_plio::create(adf::plio_32_bits, FILE_ADDR);
...
//			adf::location<adf::kernel>(k_3309) = adf::tile(2, 2);
